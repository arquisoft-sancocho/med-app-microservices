"""
Django settings for exams_system project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-=6f5rfj8*_j-cyoj7ugh6=t7r1e5&@@!$h68v4b&7l65+_)j=1')
...
ROOT_URLCONF = 'exams_system.urls'
...
WSGI_APPLICATION = 'exams_system.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'exams_db'),
