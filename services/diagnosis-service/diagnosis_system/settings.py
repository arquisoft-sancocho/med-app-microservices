"""
Django settings for diagnosis_system project.
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-diagnosis-key-change-in-production')
...
INSTALLED_APPS = [
    ...
    'diagnosticos2',   # The diagnosis app
]
...
ROOT_URLCONF = 'diagnosis_system.urls'
...
WSGI_APPLICATION = 'diagnosis_system.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'diagnosis_db'),
