"""
Django settings for surgery_system project - Surgery Microservice

Surgery microservice for medical system - handles surgical operations data
"""
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-gz+&*zme6yc$hj=01c&kidhe99ye9m&o-7d-^mey+(r45p!3c&')
...
# Application definition - Surgery service only includes surgery operations and auth
INSTALLED_APPS = [
...
ROOT_URLCONF = 'surgery_system.urls'
...
WSGI_APPLICATION = 'surgery_system.wsgi.application'

# Database - Dynamic configuration for Cloud SQL
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql_psycopg2',
        'NAME': os.getenv('DB_NAME', 'surgery_db'),
...
# Core service URL for patient data
